...
const translations: Translations = {
  ...
  // ── Catheter Registry ──
  catheterRegistry: { en: 'Catheter Registry', ne: 'क्याथेटर रजिस्ट्री' },
  catheterRegistryDesc: { en: 'Track catheter insertions, types & outcomes', ne: 'क्याथेटर राखिएको, प्रकार र परिणामहरू ट्र्याक गर्नुहोस्' },
  catheterAdded: { en: 'Catheter record added', ne: 'क्याथेटर रेकर्ड थपियो' },
  catheterRemovalRecorded: { en: 'Catheter removal recorded', ne: 'क्याथेटर हटाइयो रेकर्ड भयो' },
  noCathetersYet: { en: 'No catheters recorded yet', ne: 'अहिलेसम्म कुनै क्याथेटर रेकर्ड गरिएको छैन' },
  insertionDate: { en: 'Insertion Date', ne: 'राखिएको मिति' },
  surgeon: { en: 'Surgeon', ne: 'शल्यचिकित्सक' },
  insertionTechnique: { en: 'Technique', ne: 'प्रविधि' },
  selectTechnique: { en: 'Select technique', ne: 'प्रविधि छान्नुहोस्' },
  catheterType: { en: 'Catheter Type', ne: 'क्याथेटर प्रकार' },
  selectType: { en: 'Select type', ne: 'प्रकार छान्नुहोस्' },
  catheterBrand: { en: 'Brand', ne: 'ब्राण्ड' },
  exitSiteOrientation: { en: 'Exit Site Orientation', ne: 'बाहिरी ठाउँ दिशा' },
  selectOrientation: { en: 'Select orientation', ne: 'दिशा छान्नुहोस्' },
  omentopexy: { en: 'Omentopexy', ne: 'ओमेन्टोपेक्सी' },
  firstUseDate: { en: 'First Use Date', ne: 'पहिलो प्रयोग मिति' },
  inserted: { en: 'Inserted', ne: 'राखिएको' },
  removed: { en: 'Removed', ne: 'हटाइएको' },
  recordRemoval: { en: 'Record Removal', ne: 'हटाउने रेकर्ड' },
  reasonForRemoval: { en: 'Reason for removal', ne: 'हटाउनुको कारण' },
  confirm: { en: 'Confirm', ne: 'पुष्टि गर्नुहोस्' },
  catheter: { en: 'Catheter', ne: 'क्याथेटर' },

  // ── Fluid Registry ──
  fluidRegistry: { en: 'Fluid Registry', ne: 'तरल रजिस्ट्री' },
  fluidRegistryDesc: { en: 'Track dialysate types, concentrations & usage', ne: 'डायलिसेट प्रकार, सान्द्रता र प्रयोग ट्र्याक गर्नुहोस्' },
  fluidRecordAdded: { en: 'Fluid usage record added', ne: 'तरल प्रयोग रेकर्ड थपियो' },
  fluidUsageEnded: { en: 'Fluid usage ended', ne: 'तरल प्रयोग समाप्त भयो' },
  noFluidRecords: { en: 'No fluid usage records yet', ne: 'अहिलेसम्म कुनै तरल प्रयोग रेकर्ड छैन' },
  startDate: { en: 'Start Date', ne: 'सुरु मिति' },
  fluidType: { en: 'Fluid Type', ne: 'तरल प्रकार' },
  selectFluid: { en: 'Select fluid', ne: 'तरल छान्नुहोस्' },
  glucoseStrength: { en: 'Glucose %', ne: 'ग्लुकोज %' },
  volumeMl: { en: 'Volume (ml)', ne: 'मात्रा (मिली)' },
  exchangesDay: { en: 'Exch/Day', ne: 'एक्स/दिन' },
  day: { en: 'day', ne: 'दिन' },
  endUsage: { en: 'End Usage', ne: 'प्रयोग अन्त्य' },

  // ── Advanced Analytics ──
  medianTimeFirstPeritonitis: { en: 'Median to 1st', ne: 'पहिलो सम्म औसत' },
  catheterVsInfection: { en: 'Catheter vs Infection', ne: 'क्याथेटर बनाम संक्रमण' },
  catheterVsInfectionDesc: { en: 'Infection rates by catheter type', ne: 'क्याथेटर प्रकार अनुसार संक्रमण दर' },
  noData: { en: 'No data', ne: 'डेटा छैन' },
